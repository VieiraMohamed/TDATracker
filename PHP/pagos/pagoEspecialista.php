...
<head>
  ...
  <title>Pago Especialista Premium</title>
...
<body>
  ...
  <div class="container">
    <h3>Elige tu Plan Premium como Especialista</h3>
  ...
  <script>
    ...
    function renderPaypalButton() {
      ...
      const amount = subscriptionType === 'monthly' ? '15.00' : '130.00';
      ...
      paypal.Buttons({
        ...
        onApprove: function(data, actions) {
          return actions.order.capture().then(function(details) {
            ...
            fetch('procesar_pago_especialista.php', {
              method: 'POST',
            ...
            .then(data => {
              if (data.exito) {
                document.getElementById("resultadoPago").innerHTML = `
                  ...
                  <a href="../dashboardEspecialista.php" class="btn btn-primary">Volver al Dashboard</a>`;
              } else {
